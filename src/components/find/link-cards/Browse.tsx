...
export default function Browse() {
  return (
    <a
      href="/"
      className="group flex flex-col relative text-light aspect-[23/14.5] w-full md:w-[23rem] lg:w-[39.5rem] bg-cover bg-no-repeat bg-[url('/img/browse.jpeg')] rounded-[2.25rem]  justify-end pb-[3rem] md:pb-[4rem] items-center"
    >
